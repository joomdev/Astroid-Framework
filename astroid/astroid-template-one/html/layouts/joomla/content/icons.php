...
<div class="icons">
			...
			<div class="btn-group content-edit-dropdown float-right">
				...
				<div class="dropdown-menu" aria-labelledby="dropdownMenuButton-<?php echo $articleId; ?>">
					<?php if ($displayData['params']->get('show_print_icon')) : ?>
						<li class="dropdown-item print-icon"> <?php echo $this->sublayout('print_popup', ['legacy' => $displayData['item'], 'params' => $displayData['params']]); ?> </li>
					<?php endif; ?>
					<?php if ($displayData['params']->get('show_email_icon')) : ?>
						<li class="dropdown-item email-icon">
							<?php echo $this->sublayout('email', ['legacy' => $displayData['item'], 'params' => $displayData['params']]); ?>
						</li>
					<?php endif; ?>
					<?php if ($canEdit) : ?>
						<li class="dropdown-item edit-icon">
							<?php echo $this->sublayout('edit', ['legacy' => $displayData['item'], 'params' => $displayData['params']]); ?>
						</li>
					<?php endif; ?>
				</div>
			</div>
	...
	<?php else : ?>
		...
		<div class="float-right">
			<?php echo $this->sublayout('print_screen', ['legacy' => $displayData['item'], 'params' => $displayData['params']]); ?>
		</div>
