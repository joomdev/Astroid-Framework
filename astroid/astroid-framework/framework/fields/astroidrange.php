...
//The field class must know its own type through the variable $type.
   ...
   public function getInput() {
      ...
      $html .= '<div style="padding-top: 35px" class="position-relative"><span class="range-slider-value d-none"></span><div class="clearfix"></div><input id="' . $this->id . '_slider" data-slider-id="' . $this->id . '_slider" type="number" data-slider-min="' . $this->element['min'] . '" data-slider-max="' . $this->element['max'] . '" data-slider-tooltip="false" data-slider-step="' . $this->element['step'] . '" data-slider-value="' . $this->value . '" value="' . $this->value . '" name="' . $this->name . '" range-slider ng-model="' . $this->id . '" data-postfix=" ' . $this->element['postfix'] . '" data-prefix="' . $this->element['prefix'] . '" />' . (!empty($this->element['postfix']) ? '<span style="position: absolute;top: 0px;left: 40px;">' . $this->element['postfix'] . '</span>' : '') . '</div>';
