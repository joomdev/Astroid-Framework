      ...
      <div class="row astroid-typography-field-group">
         ...
         <div class="col-4">
			...
			<ul class="nav tabmedia" role="tablist">
			   ...
			   <li>
                  <a href="javascript:void(0);" id="astroid-font-size-tablet-<?php echo $id; ?>" data-toggle="tab" data-target="#astroid-fontsize-tablet-<?php echo $id; ?>" role="tab" aria-controls="astroid-fontsize-tablet-<?php echo $id; ?>" aria-selected="true"><i class="fa fa-tablet"></i></a>
               </li>
			   <li>
				<a href="javascript:void(0);" id="astroid-font-size-mobile-<?php echo $id; ?>" data-toggle="tab" data-target="#astroid-fontsize-mobile-<?php echo $id; ?>" role="tab" aria-controls="astroid-fontsize-mobile-<?php echo $id; ?>" aria-selected="true"><i class="fa fa-mobile"></i></a>                   
               </li>
            </ul>
            ...
            <?php if ($letterspacingpicker) { ?>
			   <ul class="nav tabmedia" role="tablist">
				   ...
				   <li>
					  <a href="javascript:void(0);" id="astroid-font-size-tablet-<?php echo $id; ?>" data-toggle="tab" data-target="#astroid-letterspacing-tablet-<?php echo $id; ?>" role="tab" aria-controls="astroid-letterspacing-tablet-<?php echo $id; ?>" aria-selected="true"><i class="fa fa-tablet"></i></a>
				   </li>
				   <li>
					<a href="javascript:void(0);" id="astroid-font-size-mobile-<?php echo $id; ?>" data-toggle="tab" data-target="#astroid-letterspacing-mobile-<?php echo $id; ?>" role="tab" aria-controls="astroid-letterspacing-mobile-<?php echo $id; ?>" aria-selected="true"><i class="fa fa-mobile"></i></a>                   
				   </li>
				</ul>	
				<div class="tab-content" id="astroid-font-size-tab-content">
					<?php foreach($media_types as $k=>$mtype){ ?>
            ...
            <?php if ($lineheightpicker) { ?>
				<ul class="nav tabmedia" role="tablist">
				   ...
				   <li>
					  <a href="javascript:void(0);" id="astroid-line-height-tablet-<?php echo $id; ?>" data-toggle="tab" data-target="#astroid-lineheight-tablet-<?php echo $id; ?>" role="tab" aria-controls="astroid-lineheight-tablet-<?php echo $id; ?>" aria-selected="true"><i class="fa fa-tablet"></i></a>
				   </li>
				   <li>
					<a href="javascript:void(0);" id="astroid-line-height-mobile-<?php echo $id; ?>" data-toggle="tab" data-target="#astroid-lineheight-mobile-<?php echo $id; ?>" role="tab" aria-controls="astroid-lineheight-mobile-<?php echo $id; ?>" aria-selected="true"><i class="fa fa-mobile"></i></a>                   
				   </li>
				</ul>
