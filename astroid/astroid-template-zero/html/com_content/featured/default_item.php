...
<div class="row mb-5">
   <div class="col">
      <div class="card">
         ...
         <a href="<?php echo JRoute::_(ContentHelperRoute::getArticleRoute($this->item->slug, $this->item->catid, $this->item->language)); ?>" itemprop="url"><img class="card-img-top img-fluid" itemprop="thumbnailUrl" alt="" src="<?php echo $images->image_intro; ?>" /></a>
         <?php endif; ?>
         <div class="card-body">
